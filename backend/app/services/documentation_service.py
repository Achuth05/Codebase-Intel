...
def generate_readme(repo_name: str) -> dict:
    ...
    # Load parsed files metadata from graph
    file_nodes = [
...
def generate_function_docs(repo_name: str, file_path: str) -> dict:
    G = load_graph(repo_name)
    ...
    for func in summary["functions"]:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Write a concise docstring for this function. Return only the docstring text, no code."
                },
                {
                    "role": "user",
